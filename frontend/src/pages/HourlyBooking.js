...
const HourlyBooking = () => {
  ...
  const initialHours = useMemo(() => {
    ...
    return HOURS_OPTIONS.includes(h) ? h : 4;
  }, [searchParams]);
                  ...
                  {loadingCars ? (
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {cars.map(car => {
                        ...
                        const hourPrice = perMin * 60;
                        const totalPrice = Math.max(perMin * hours * 60 + baseFare, minP);

...
const labels = {
  ...
  fr: {
    ...
    cardNote: 'Votre carte sera debitee des la confirmation de la reservation.',
    secureNote: 'La verification 3D Secure affichera 0\u20AC \u2014 c\'est normal. Elle sert uniquement a valider votre carte.',
    cardExplain: 'Une fois votre carte verifiee, le montant sera debite et votre reservation confirmee immediatement.',

...
const content = {
  ...
  hy: {
    metaTitle: 'MICE Տրանսպորտ Փարիզ | Վարորդի ծառայություններ և միջոցառումների տրանսպորտ | ZONT',
    metaDesc: 'Պրոֆեսիոնալ MICE տրանսպորտ Փարիզում. վարորդի ծառայություններ, օդանավակայանային տրանսֆերներ, կոնֆերանսների շաթլներ, VIP փոխադրումներ և խմբային տրանսպորտ:',
    h1: 'MICE Տրանսպորտ Փարիզում',
    subtitle: 'Պրոֆեսիոնալ վարորդի ծառայություններ և միջոցառումների տրանսպորտ',
    heroDesc: 'Պրեմիում ցամաքային տրանսպորտ հանդիպումների, խրախուսումների, կոնֆերանսների և ցուցահանդեսների համար Փարիզում և Իլ-դե-Ֆրանսում:',
    ctaQuote: 'Խնդրել առաջարկություն',
    ctaCall: 'Զանգահարել',
    ctaWhatsApp: 'WhatsApp',
    intro1: 'Zont-ը մատուցում է պրոֆեսիոնալ MICE տրանսպորտային ծառայություններ Փարիզում՝ հանդիպումների, խրախուսումների, կոնֆերանսների, ցուցահանդեսների, ցուցասենյակների, կորպորատիվ միջոցառումների և միջազգային գործնական ուղևորությունների համար: Մենք օգնում ենք միջոցառումների կազմակերպիչներին, ճամփորդական գործակալություններին, DMC-ներին, հյուրանոցներին, կորպորատիվ հաճախորդներին և կոնֆերանսների կազմակերպիչներին արդյունավետ կառավարել տրանսպորտը Փարիզում և Իլ-դե-Ֆրանսում:',
    intro2: 'Անկախ նրանից՝ դա VIP հյուրերի համար օդանավակայանից տրանսֆերներ են, հյուրանոցների և միջոցառումների վայրերի միջև շաթլներ, ղեկավարների համար վարորդի ծառայություններ, թե մեծ խմբերի համար տրանսպորտ՝ Zont-ը առաջարկում է հուսալի, մասշտաբավորելի և պրոֆեսիոնալ շարժունակության լուծումներ՝ հարմարեցված ձեր միջոցառման պահանջներին:',
    miceTitle: 'Ի՞նչ է MICE տրանսպորտը',
    miceText: 'MICE-ը վերծանվում է որպես Meetings, Incentives, Conferences and Exhibitions (Հանդիպումներ, Խրախուսումներ, Կոնֆերանսներ և Ցուցահանդեսներ): Հաջողված միջոցառումները պահանջում են ճշգրիտ պլանավորում, ճշտապահ վարորդներ և անթերի համակարգում օդանավակայանների, հյուրանոցների, կոնֆերանսի կենտրոնների և միջոցառումների վայրերի միջև: Մեր օպերացիոն թիմը ապահովում է յուրաքանչյուր հյուրի, բանախոսի, ղեկավարի և մասնակցի հարմարավետ և ժամանակին ժամանումը:',
    airportsTitle: 'Օդանավակայանային տրանսֆերներ կոնֆերանսների և միջոցառումների համար',
    airportsDesc: 'Իրական ժամանակում թռիչքների հետևում, VIP հյուրերի, ղեկավարների, բանախոսների և միջազգային պատվիրակությունների դիմավորում:',
    airports: [
      { name: 'Փարիզ Շառլ դե Գոլ օդանավակայան (CDG)', icon: 'plane' },
      { name: 'Փարիզ Օռլի օդանավակայան (ORY)', icon: 'plane' },
      { name: 'Փարիզ Բովե օդանավակայան (BVA)', icon: 'plane' },
      { name: 'Մասնավոր ավիացիա և բիզնես օդանավակայաններ', icon: 'crown' },
    ],
    venuesTitle: 'Միջոցառումների տրանսպորտ Փարիզում',
    venuesDesc: 'Խոշոր կոնֆերանսների, ցուցահանդեսների, կոնվենցիաների և կորպորատիվ միջոցառումների համակարգում:',
    venues: [
      'Paris Expo Porte de Versailles',
      'Palais des Congrès de Paris',
      'Le Bourget ցուցահանդեսային կենտրոն',
      'Carrousel du Louvre',
      'Դիսնեյլենդ Փարիզ',
      'La Défense բիզնես թաղամաս',
    ],
    execTitle: 'Ղեկավարների համար վարորդի ծառայություններ',
    execDesc: 'Բարձրագույն ղեկավարների, կորպորատիվ հաճախորդների և VIP հյուրերի համար մեր փորձառու պրոֆեսիոնալ վարորդները ապահովում են պրեմիում տրանսպորտ վարորդի հետ:',
    execList: [
      'VIP օդանավակայանային տրանսֆերներ',
      'Գործնական հանդիպումներ',
      'Ցուցահանդեսային ուղևորություններ',
      'Կորպորատիվ ընդունելություններ',
      'VIP տրանսպորտ',
      'Ժամային մասնավոր վարորդ',
      'Բազմօրյա ուղեկցում',
    ],
    groupTitle: 'Խմբային տրանսպորտ և միջոցառումների լոգիստիկա',
    groupDesc: 'Խմբերի համար տրանսպորտի կառավարումը պահանջում է մանրակրկիտ պլանավորում և օպերացիոն փորձ:',
    groupList: [
      { title: 'Բիզնես սեդաններ', desc: 'Mercedes E-Class / BMW 5 Series — մինչև 3 ուղևոր' },
      { title: 'Executive մեքենաներ', desc: 'Mercedes S-Class / BMW 7 Series — VIP-ի համար' },
      { title: 'Պրեմիում մինիվեններ', desc: 'Mercedes V-Class — մինչև 7 ուղևոր ուղեբեռով' },
      { title: 'Մինիավտոբուսներ', desc: 'Renault Trafic 8 տեղ կամ նմանատիպ' },
      { title: 'Խմբային տրանսպորտ', desc: 'Ավտոբուսներ մինչև 50+ ուղևոր' },
      { title: 'Մի քանի մեքենաների համակարգում', desc: 'Ավտոպարկի կառավարում պատվիրակությունների համար' },
    ],
    partnersTitle: 'Տրանսպորտ հյուրանոցների և միջոցառումների գործակալությունների համար',
    partnersDesc: 'Ճկուն B2B լուծումներ գործընկերների համար, ովքեր կառավարում են մեծ ծավալի տրանսպորտային հարցումներ:',
    partnersList: [
      'Միջոցառումների կազմակերպիչներ',
      'Destination Management Companies (DMC)',
      'Ճամփորդական գործակալություններ',
      'Տուր-օպերատորներ',
      'Հյուրանոցներ',
      'Կորպորատիվ ճամփորդական բաժիններ',
      'Կոնֆերանսների կազմակերպիչներ',
    ],
    whyTitle: 'Ինչու՞ ընտրել Zont-ը MICE տրանսպորտի համար Փարիզում',
    whyList: [
      { title: 'Պրոֆեսիոնալ վարորդներ', icon: 'shield' },
      { title: 'Օպերացիոն աջակցություն 24/7', icon: 'clock' },
      { title: 'Իրական ժամանակում համակարգում', icon: 'calendar' },
      { title: 'Ֆիքսված թափանցիկ գներ', icon: 'award' },
      { title: 'Օդանավակայանում դիմավորում', icon: 'plane' },
      { title: 'Executive և խմբային տրանսպորտ', icon: 'users' },
      { title: 'Փարիզ և Իլ-դե-Ֆրանս ծածկույթ', icon: 'map' },
      { title: 'Աջակցություն կազմակերպիչներին', icon: 'briefcase' },
      { title: 'Հուսալիություն միջազգային հյուրերի համար', icon: 'crown' },
    ],
    formTitle: 'Խնդրել MICE տրանսպորտի առաջարկություն',
    formDesc: 'Պլանավորու՞մ եք կոնֆերանս, ցուցահանդես, կորպորատիվ միջոցառում, խրախուսական ուղևորություն կամ գործնական հանդիպում Փարիզում: Մեր թիմը 24 ժամվա ընթացքում կպատասխանի անհատականացված առաջարկով:',
    formName: 'Ձեր անունը',
    formCompany: 'Ընկերության անվանումը',
    formEmail: 'Կորպորատիվ email',
    formPhone: 'Հեռախոս',
    formMessage: 'Նկարագրեք ձեր միջոցառումը՝ ամսաթվեր, հյուրերի քանակ, հիմնական երթուղիներ, վայրեր...',
    formSubmit: 'Ուղարկել դիմումը',
    formSending: 'Ուղարկվում է...',
    formSuccess: 'Շնորհակալություն: Մեր թիմը կկապվի ձեզ հետ 24 ժամվա ընթացքում:',
    formError: 'Սխալ տեղի ունեցավ: Փորձեք կրկին կամ գրեք մեզ WhatsApp-ով:',
    closing: 'Zont — ձեր վստահելի գործընկերը MICE տրանսպորտի ոլորտում Փարիզում:',
  },
  es: {
    metaTitle: 'Transporte MICE París | Servicios de Chófer y Transporte para Eventos | ZONT',
    metaDesc: 'Transporte MICE profesional en París. Servicios de chófer, traslados de aeropuerto, lanzaderas para conferencias, transporte VIP y transporte grupal.',
    h1: 'Transporte MICE en París',
    subtitle: 'Servicios profesionales de chófer y transporte para eventos',
    heroDesc: 'Transporte terrestre premium para reuniones, incentivos, conferencias y exhibiciones en París e Île-de-France.',
    ctaQuote: 'Solicitar presupuesto',
    ctaCall: 'Llamar',
    ctaWhatsApp: 'WhatsApp',
    intro1: 'Zont ofrece servicios profesionales de transporte MICE en París para reuniones, incentivos, conferencias, exhibiciones, ferias comerciales, eventos corporativos y viajes de negocios internacionales. Ayudamos a organizadores de eventos, agencias de viajes, DMC, hoteles, clientes corporativos y organizadores de conferencias a gestionar eficazmente el transporte en París e Île-de-France.',
    intro2: 'Ya sean traslados desde el aeropuerto para invitados VIP, lanzaderas entre hoteles y sedes de eventos, servicios de chófer para directivos o transporte para grandes grupos — Zont propone soluciones de movilidad fiables, escalables y profesionales, adaptadas a las necesidades de tu evento.',
    miceTitle: '¿Qué es el transporte MICE?',
    miceText: 'MICE es el acrónimo de Meetings, Incentives, Conferences and Exhibitions (Reuniones, Incentivos, Conferencias y Exhibiciones). Los eventos exitosos requieren una planificación de transporte precisa, chóferes puntuales y una coordinación impecable entre aeropuertos, hoteles, centros de conferencias y sedes. Nuestro equipo operativo garantiza la llegada cómoda y puntual de cada invitado, ponente, directivo y participante.',
    airportsTitle: 'Traslados desde el aeropuerto para conferencias y eventos',
    airportsDesc: 'Seguimiento de vuelos en tiempo real, recepción de invitados VIP, directivos, ponentes y delegaciones internacionales.',
    airports: [
      { name: 'Aeropuerto París Charles-de-Gaulle (CDG)', icon: 'plane' },
      { name: 'Aeropuerto París-Orly (ORY)', icon: 'plane' },
      { name: 'Aeropuerto París-Beauvais (BVA)', icon: 'plane' },
      { name: 'Aviación privada y aeropuertos de negocios', icon: 'crown' },
    ],
    venuesTitle: 'Transporte para eventos en París',
    venuesDesc: 'Coordinación de grandes conferencias, exhibiciones, convenciones y eventos corporativos.',
    venues: [
      'Paris Expo Porte de Versailles',
      'Palais des Congrès de Paris',
      'Centro de exposiciones Le Bourget',
      'Carrousel du Louvre',
      'Disneyland Paris',
      'Distrito de negocios La Défense',
    ],
    execTitle: 'Servicios de chófer para directivos',
    execDesc: 'Para altos directivos, clientes corporativos e invitados VIP, nuestros chóferes profesionales experimentados garantizan un transporte premium con chófer privado.',
    execList: [
      ...
      'Acompañamiento de varios días',
    ],
    groupTitle: 'Transporte grupal y logística de eventos',
    groupDesc: 'La gestión del transporte para grupos requiere una planificación minuciosa y experiencia operativa.',
    groupList: [
      { title: 'Sedanes de negocios', desc: 'Mercedes Clase E / BMW Serie 5 — hasta 3 pasajeros' },
      { title: 'Vehículos Executive', desc: 'Mercedes Clase S / BMW Serie 7 — para VIP' },
      { title: 'Furgonetas premium', desc: 'Mercedes Clase V — hasta 7 pasajeros con equipaje' },
      { title: 'Minibuses', desc: 'Renault Trafic 8 plazas o similar' },
      { title: 'Transporte grupal', desc: 'Autobuses hasta 50+ pasajeros' },
      { title: 'Coordinación de varios vehículos', desc: 'Despacho de flota para delegaciones' },
    ],
    partnersTitle: 'Transporte para hoteles y agencias de eventos',
    partnersDesc: 'Soluciones B2B flexibles para socios que gestionan solicitudes de transporte de gran volumen.',
    partnersList: [
    ...
    whyTitle: '¿Por qué elegir Zont para el transporte MICE en París?',
    whyList: [
      { title: 'Chóferes profesionales', icon: 'shield' },
      { title: 'Soporte operativo 24/7', icon: 'clock' },
      { title: 'Coordinación en tiempo real', icon: 'calendar' },
      { title: 'Precios fijos transparentes', icon: 'award' },
      { title: 'Recepción en el aeropuerto', icon: 'plane' },
      { title: 'Transporte Executive y grupal', icon: 'users' },
      { title: 'Cobertura París e Île-de-France', icon: 'map' },
      { title: 'Soporte para organizadores', icon: 'briefcase' },
      { title: 'Fiabilidad para invitados internacionales', icon: 'crown' },
    ],
    formTitle: 'Solicitar presupuesto de transporte MICE',
    formDesc: '¿Planificas una conferencia, exhibición, evento corporativo, viaje de incentivo o reunión de negocios en París? Nuestro equipo responderá con una propuesta personalizada en 24 horas.',
    formName: 'Tu nombre',
    formCompany: 'Nombre de la empresa',
    formEmail: 'Email corporativo',
    formPhone: 'Teléfono',
    formMessage: 'Describe tu evento: fechas, número de invitados, rutas principales, sedes...',
    formSubmit: 'Enviar la solicitud',
    formSending: 'Enviando...',
    formSuccess: '¡Gracias! Nuestro equipo se pondrá en contacto contigo en 24 horas.',
    formError: 'Se ha producido un error. Inténtalo de nuevo o escríbenos por WhatsApp.',
    closing: 'Zont — tu socio de confianza en transporte MICE en París.',
  },
};
...
const URLS = {
  ...
  hy: '/mice-transport-pariz-hy',
  es: '/es/transporte-mice-paris',
};
...
const MICETransportation = () => {
  ...
  const detectedLang = (() => {
    ...
    if (location.pathname === URLS.hy) return 'hy';
    if (location.pathname === URLS.es) return 'es';

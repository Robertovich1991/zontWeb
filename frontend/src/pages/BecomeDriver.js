...
const t = {
  en: {
    ...
    benefits: [
      ...
      { title: 'Growing Network', desc: 'Connect with travelers from 16 cities worldwide. Expanding customer base.' },
      { title: 'Easy Management', desc: 'Register your vehicles and drivers. Simple dashboard to manage everything.' },
    ],
    stats: { drivers: '2,500+', driversLabel: 'Active Drivers', cities: '16', citiesLabel: 'Cities', earnings: '3,200', earningsLabel: 'Avg Monthly', rating: '4.5/5', ratingLabel: 'Rating' },
  ...
  fr: {
    ...
    benefits: [
      ...
      { title: 'Reseau en Croissance', desc: 'Connectez avec des voyageurs de 16 villes. Base de clients en expansion.' },
      { title: 'Gestion Facile', desc: 'Enregistrez vos vehicules et chauffeurs. Tableau de bord simple pour tout gerer.' },
    ],
    stats: { drivers: '2 500+', driversLabel: 'Chauffeurs Actifs', cities: '16', citiesLabel: 'Villes', earnings: '3 200', earningsLabel: 'Moy. Mensuel', rating: '4.5/5', ratingLabel: 'Note' },
  ...
  ru: {
    ...
    benefits: [
      ...
      { title: 'Растущая Сеть', desc: 'Связь с путешественниками из 16 городов мира.' },
      { title: 'Простое Управление', desc: 'Регистрируйте автомобили и водителей. Простая панель управления.' },
    ],
    stats: { drivers: '2 500+', driversLabel: 'Водителей', cities: '16', citiesLabel: 'Городов', earnings: '3 200', earningsLabel: 'Ср. Месячный', rating: '4.5/5', ratingLabel: 'Рейтинг' },
  ...
  hy: {
    seoTitle: 'Դառնալ վարորդ - Միանալ Zont-ին',
    seoDesc: 'Միացեք Zont-ին որպես տրանսպորտային ընկերություն.',
    heroTitle: 'Գրանցեք ձեր ընկերությունը',
    heroAccent: 'Zont-ում',
    heroSub: 'Միացեք պրոֆեսիոնալ տրանսպորտային ընկերությունների ցանցին',
    badge: 'Հավաքագրում ընթացում է',
    whyTitle: 'Ինչու դառնալ գործընկեր Zont-ի հետ?',
    benefits: [
      { title: 'Վաստակեք ավելին', desc: 'Սահմանեք ձեր գրաֆիկը և վաստակեք մրցունակային սակագներ: Շաբաթական վճարումներ:' },
      { title: 'Ճկուն գրաֆիկ', desc: 'Աշխատեք երբ ուզում եք: Դուք վերահսկում եք ձեր գրաֆիկը:' },
      { title: 'Հանդիպեք մարդկանց', desc: 'Կապվեք աշխարհի բոլոր կողմերից ճամորդների հետ:' },
      { title: 'Օգտագործեք ձեր մեքենան', desc: 'Վաստակեք ձեր գոյություն ունեցող մեքենայով: Mercedes, BMW:' },
    ],
    stats: { drivers: '2 500+', driversLabel: 'Ակտիվ վարորդներ', cities: '16', citiesLabel: 'Քաղաքներ', earnings: '3 200', earningsLabel: 'Միջին ամսական', rating: '4.5/5', ratingLabel: 'Վարկանիշ' },
    formTitle: 'Ընկերության գրանցում',
    formSub: 'Ստեղծեք ձեր ընկերության հաշիվը ձեր նավատիղը կառավարելու համար',
    firstName: 'Անուն', lastName: 'Ազգանուն',
    companyName: 'Ընկերության անունը', companyAddress: 'Ընկերության հասցեն',
    email: 'Էլ. փոստ', phone: 'Բջջային հեռախոս',
    password: 'Գաղտնաբառ', confirmPassword: 'Հաստատեք գաղտնաբառը',
    terms: 'Համաձայն եմ', termsLink: 'Ծառայության պայմաններին', and: 'և', privacyLink: 'Գաղտնիության քաղաքականությանը',
    submit: 'Գրանցվել', sending: 'Գրանցում...',
    alreadyAccount: 'Արդեն հաշիվ ունեք?', signIn: 'Մուտք գործեք',
    successTitle: 'Գրանցումը հաջողվեց!', successDesc: 'Ձեր ընկերության հաշիվը ստեղծվել է: Մենք կկապվենք ձեզ շուտով:',
    errorEmail: 'Այս էլ. հասցեն արդեն գրանցված է:', errorMatch: 'Գաղտնաբառերը չեն համընկնում:',
    errorTerms: 'Դուք պետք է ընդունեք պայմանները:',
    requirements: 'Ինչ կստանաք',
    reqItems: ['Նավատիղի կառավարման վահանակ', 'Մեքենաների անսահմանաֆակ գրանցում', 'Վարորդների ավելացում և կառավարում', 'Օդանավայրի տրանսֆերի պատվերների հասանելիություն', 'Շաբաթական ավտոմատ վճարումներ'],
  },
};

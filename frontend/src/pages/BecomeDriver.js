...
const content = {
  ...
  hy: {
    seoTitle: 'Դառնալ Վարորդ - Միացեք Zont-ին | Պրոֆեսիոնալ Վարորդ',
    seoDesc: 'Միացեք Zont-ին որպես պրոֆեսիոնալ վարորդ: Ճկուն գրաֆիկ, մրցունակ վարձատրություն:',
    heroTitle: 'Դառնալ Վարորդ',
    heroSub: 'Միացեք հազարավոր վարորդներին, ովքեր վաստակում են իրենց գրաֆիկով Zont-ի հետ',
    whyTitle: 'Ինչու Աշխատել Zont-ի Հետ՞',
    benefits: [
      { title: 'Վաստակեք Ավելին', desc: 'Սահմանեք ձեր գրաֆիկը և վաստակեք մրցունակ վարձատրություն յուրաքանչյուր ուղևորության համար:' },
      { title: 'Ճկուն Գրաֆիկ', desc: 'Վարեք երբ ուզում եք: Դուք վերահսկում եք ձեր գրաֆիկը:' },
      { title: 'Հանդիպեք Մարդկանց', desc: 'Կապվեք աշխարհի տարբեր մասերից ճամորդների հետ:' },
      { title: 'Օգտագործեք Ձեր Մեքենան', desc: 'Վաստակեք ձեր գոյություն ունեցող մեքենայով:' },
    ],
    formTitle: 'Դիմել Վարորդի Համար',
    formSub: 'Լրացրեք ստորև ձևը և մենք կկապվենք 24 ժամվա ընթացքում',
    fullName: 'Լիարժեք Անուն *', email: 'Email *', phone: 'Հեռախոս *', city: 'Քաղաք *',
    carModel: 'Մեքենայի Մոդել *', carYear: 'Մեքենայի Տարի *', license: 'Վարորդական Իրավունքի Համար *',
    message: 'Լրացուցիչ Տեղեկատվություն (Կամավոր)',
    messagePlaceholder: 'Պատմեք թե ինչու եք ուզում աշխատել Zont-ի հետ...',
    submit: 'Ուղարկել Դիմումը', sending: 'Ուղարկվում է...',
    successTitle: 'Դիմումը ուղարկվեց!', successDesc: 'Մենք կքննարկենք ձեր դիմումը և կկապվենք շուտով:',
    errorTitle: 'Սխալ', errorDesc: 'Սխալ տեղի ունեցավ դիմումը ուղարկելիս:',
  },
};

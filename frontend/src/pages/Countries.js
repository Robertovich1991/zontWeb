...
const translations = {
  en: {
    ...
    seoDesc: 'Premium private airport transfer in 16 European cities. Fixed prices, flight tracking. Book online.',
    heroTitle: 'Airport Transfers', heroAccent: 'Across Europe',
    heroSub: 'Premium private driver service in 16 cities. Book your airport transfer with fixed prices and professional drivers.',
    searchPh: 'Search a city or airport...',
    stats: [{ v: '16', l: 'Cities' }, { v: '6', l: 'Countries' }, { v: '24/7', l: 'Service' }, { v: '4.5/5', l: 'Rating' }],
    ...
    t4: 'Secure Payment', t4d: 'Visa, Mastercard, Apple Pay',
  ...
  fr: {
    seoTitle: 'Transferts Aéroport en Europe - Toutes les Destinations | Zont',
    seoDesc: 'Transfert aéroport privé premium dans 16 villes européennes. Prix fixes, suivi de vol. Réservez en ligne.',
    heroTitle: 'Transferts Aéroport', heroAccent: 'Partout en Europe',
    heroSub: 'Service de chauffeur privé premium dans plus de 120 villes. Réservez votre transfert aéroport à prix fixes.',
    searchPh: 'Rechercher une ville ou un aéroport...',
    stats: [{ v: '16', l: 'Villes' }, { v: '6', l: 'Pays' }, { v: '24/7', l: 'Service' }, { v: '4.5/5', l: 'Note' }],
    browseTitle: 'Choisissez Votre Destination',
    viewCity: 'Réserver un Transfert', from: 'À partir de', airports: 'Aéroports',
    noResults: 'Aucune destination trouvée pour',
    trustTitle: 'Pourquoi Choisir Zont ?',
    t1: 'Prix Fixes', t1d: 'Pas de frais cachés, prix confirmé à la réservation',
    t2: 'Suivi des Vols', t2d: 'Surveillance en temps réel, attente gratuite',
    t3: 'Véhicules Premium', t3d: 'Mercedes, BMW, moins de 3 ans',
    t4: 'Paiement Sécurisé', t4d: 'Visa, Mastercard, Apple Pay',
    ctaTitle: 'Prêt à Réserver ?', ctaText: 'Choisissez votre ville ci-dessus ou contactez-nous.',
    downloadIos: 'Télécharger pour iOS', downloadAndroid: 'Télécharger pour Android',
  },
  ru: {
    seoTitle: 'Трансферы из Аэропортов Европы - Все Направления | Zont',
    seoDesc: 'Премиум трансфер из аэропорта в 16 городах Европы. Фиксированные цены.',
    heroTitle: 'Трансферы из Аэропортов', heroAccent: 'По Всей Европе',
    heroSub: 'Премиум-сервис частного водителя в 16 городах. Забронируйте трансфер по фиксированным ценам.',
    searchPh: 'Поиск города или аэропорта...',
    stats: [{ v: '16', l: 'Городов' }, { v: '6', l: 'Стран' }, { v: '24/7', l: 'Сервис' }, { v: '4.5/5', l: 'Рейтинг' }],
    ...
    t4: 'Безопасная Оплата', t4d: 'Visa, Mastercard, Apple Pay',
  ...
  hy: {
    ...
    seoDesc: 'Պրեմիում անձնական օդանավակայանի տրանսֆեր 16 եվրոպական քաղաքներում: Հաստատ գներ:',
    heroTitle: 'Օդանավակայանի Տրանսֆերներ', heroAccent: 'Ամբողջ Եվրոպայում',
    heroSub: 'Պրեմիում անձնական վարորդի ծառայություն 16 քաղաքներում: Ամրագրեք հաստատ գներով:',
    searchPh: 'Որոնել քաղաք կամ օդանավակայան...',
    stats: [{ v: '16', l: 'Քաղաքներ' }, { v: '6', l: 'Երկրներ' }, { v: '24/7', l: 'Սպասարկում' }, { v: '4.5/5', l: 'Վարկանիշ' }],
    ...
    t4: 'Ապահով Վճարում', t4d: 'Visa, Mastercard, Apple Pay',

...
const content = {
  ...
  hy: {
    seoTitle: 'Ինչպես Է Աշխատում - Ամրագրեք Տրանսֆեր | Zont',
    seoDesc: 'Իմացեք թե ինչպես ամրագրել օդանավակայանի տրանսֆեր Zont-ի հետ 4 պարզ քայլով:',
    heroTitle: 'Ինչպես Է Աշխատում',
    heroSub: 'Ամրագրեք ձեր պրեմիում օդանավակայանի տրանսֆերը 4 պարզ քայլով',
    steps: [
      { icon: 'smartphone', title: 'Ներբեռնեք Հավելվածը', desc: 'Ստացեք Zont հավելվածը անվճար iOS կամ Android-ի համար: Ստեղծեք հաշիվ վայրկյաններում:' },
      { icon: 'search', title: 'Մուտքագրեք Ուղղությունը', desc: 'Մուտքագրեք վերցնելու և իջնելու վայրերը: Տեսեք գինը անմիջապես:' },
      { icon: 'mappin', title: 'Հանդիպեք Վարորդին', desc: 'Վարորդը ժամանին է: Հետևեք քարտեզին իրական ժամանակում:' },
      { icon: 'check', title: 'Վայելեք Ուղևորությունից', desc: 'Հանգստացեք և հանգստացեք: Գնահատեք ձեր փորձը յուրաքանչյուր ուղևորությունից հետո:' },
    ],
    whyTitle: 'Ինչու Հազարավորները Ընտրում Են Zont-ը',
    whyPoints: [
      { title: 'Հաստատ Գներ', desc: 'Իմացեք ճիշտ գինը ամրագրելուց առաջ: Անակնկալներ չկան:' },
      { title: 'Պրոֆեսիոնալ Վարորդներ', desc: 'Բոլոր վարորդները ստուգված, լիցենզավորված և բարձր գնահատված են:' },
      { title: 'Թռիչքի Հետևելում', desc: 'Մենք հետևում ենք ձեր թռիչքը: Ուշացման դեպքում վարորդը հարմարեցվում է ավտոմատ:' },
      { title: 'Աջակցություն 24/7', desc: 'Մեր թիմը հասանելի է շուրջօրյա ցանկացած հարցի համար:' },
    ],
    ctaTitle: 'Պատրաստ՞ Եք Սկսել՞',
    ctaSub: 'Ներբեռնեք հավելվածը և ամրագրեք ձեր առաջին ուղևորությունը այսօր:',
    ctaBtn: 'Ստանալ Հավելվածը',
  },
};

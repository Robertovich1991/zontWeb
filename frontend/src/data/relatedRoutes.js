...
export const CITY_ROUTES = {
  ...
  'gare-de-lyon': {
    urls: { en: '/gare-de-lyon-transfer', fr: '/transfert-gare-de-lyon', ru: '/transfer-gar-de-lion', hy: '/gar-de-lion-transfer' },
    labels: { en: 'Gare de Lyon', fr: 'Gare de Lyon', ru: 'Вокзал де Лион', hy: 'Gare de Lyon', es: 'Gare de Lyon' },
    related: ['gare-du-nord', 'gare-montparnasse', 'gare-saint-lazare', 'gare-est', 'paris-train', 'cdg', 'disneyland'],
  },
  'gare-du-nord': {
    urls: { en: '/gare-du-nord-transfer', fr: '/transfert-gare-du-nord', ru: '/transfer-gar-dyu-nor', hy: '/gar-dyu-nor-transfer' },
    labels: { en: 'Gare du Nord', fr: 'Gare du Nord', ru: 'Вокзал дю Нор', hy: 'Gare du Nord', es: 'Gare du Nord' },
    related: ['gare-de-lyon', 'gare-montparnasse', 'gare-saint-lazare', 'gare-est', 'paris-train', 'cdg', 'orly'],
  },
  'gare-montparnasse': {
    urls: { en: '/gare-montparnasse-transfer', fr: '/transfert-gare-montparnasse', ru: '/transfer-gar-monparnas', hy: '/gar-monparnas-transfer' },
    labels: { en: 'Gare Montparnasse', fr: 'Gare Montparnasse', ru: 'Вокзал Монпарнас', hy: 'Gare Montparnasse', es: 'Gare Montparnasse' },
    related: ['gare-de-lyon', 'gare-du-nord', 'gare-saint-lazare', 'gare-est', 'paris-train', 'orly', 'disneyland'],
  },
  'gare-saint-lazare': {
    urls: { en: '/gare-saint-lazare-transfer', fr: '/transfert-gare-saint-lazare', ru: '/transfer-gar-sen-lazar', hy: '/gar-sen-lazar-transfer' },
    labels: { en: 'Gare Saint-Lazare', fr: 'Gare Saint-Lazare', ru: 'Вокзал Сен-Лазар', hy: 'Gare Saint-Lazare', es: 'Gare Saint-Lazare' },
    related: ['gare-de-lyon', 'gare-du-nord', 'gare-montparnasse', 'gare-est', 'paris-train', 'cdg', 'disneyland'],
  },
  'gare-est': {
    urls: { en: '/gare-austerlitz-transfer', fr: '/transfert-gare-austerlitz', ru: '/transfer-gar-osterlits', hy: '/gar-osterlits-transfer' },
    labels: { en: 'Gare d\'Austerlitz', fr: 'Gare d\'Austerlitz', ru: 'Вокзал Аустерлиц', hy: 'Gare d\'Austerlitz', es: 'Gare d\'Austerlitz' },
    related: ['gare-de-lyon', 'gare-du-nord', 'gare-montparnasse', 'gare-saint-lazare', 'paris-train', 'cdg', 'disneyland'],
  },
  nice: {
    urls: { en: '/nice-airport-transfer', fr: '/transfert-aeroport-nice', ru: '/taksi-iz-aeroporta-nitstsa', hy: '/nis-odanavakayani-transfer' },
  ...
  cannes: {
    urls: { en: '/cannes-airport-transfer', fr: '/transfert-aeroport-cannes', ru: '/taksi-iz-aeroporta-kanny', hy: '/kann-odanavakayani-transfer' },
    labels: { en: 'Cannes Transfer', fr: 'Cannes', ru: 'Канны', hy: 'Կան', es: 'Cannes' },
    related: ['nice', 'monaco', 'milan', 'rome', 'barcelona', 'cdg', 'paris-airport'],
  },
  monaco: {
    urls: { en: '/monaco-airport-transfer', fr: '/transfert-aeroport-monaco', ru: '/taksi-iz-aeroporta-monako', hy: '/monako-odanavakayani-transfer' },
  ...
  milan: {
    urls: { en: '/milan-airport-transfer', fr: '/transfert-aeroport-milan', ru: '/taksi-iz-aeroporta-milan', hy: '/milan-odanavakayani-transfer' },
  ...
  rome: {
    urls: { en: '/rome-airport-transfer', fr: '/transfert-aeroport-rome', ru: '/taksi-iz-aeroporta-rim', hy: '/hrom-odanavakayani-transfer' },
  ...
  barcelona: {
    urls: { en: '/barcelona-airport-transfer', fr: '/transfert-aeroport-barcelone', ru: '/taksi-iz-aeroporta-barselona', hy: '/barselona-odanavakayani-transfer' },
  ...
  alicante: {
    urls: { en: '/alicante-airport-transfer', fr: '/transfert-aeroport-alicante', ru: '/taksi-iz-aeroporta-alikante', hy: '/alikante-odanavakayani-transfer' },
  ...
  berlin: {
    urls: { en: '/berlin-airport-transfer', fr: '/transfert-aeroport-berlin', ru: '/taksi-iz-aeroporta-berlin', hy: '/berlin-odanavakayani-transfer' },
  ...
  munich: {
    urls: { en: '/munich-airport-transfer', fr: '/transfert-aeroport-munich', ru: '/taksi-iz-aeroporta-munhen', hy: '/myunkhen-odanavakayani-transfer' },

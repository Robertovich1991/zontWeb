              ...
              <div className="relative">
                ...
                {servicesDropdownOpen && (
                  <div className="absolute top-full mt-2 bg-[#1a2332] border border-gray-700 rounded shadow-lg py-2 min-w-[200px]">
                    ...
                    >
                      {language === 'en' ? 'VTC 7 Seats' : language === 'ru' ? 'VTC 7 Мест' : language === 'hy' ? 'VTC 7 Տեղ' : 'VTC 7 Places'}
                    </Link>
                    <Link
                    ...
                    >
                      {language === 'en' ? 'VTC 8 Seats' : language === 'ru' ? 'VTC 8 Мест' : language === 'hy' ? 'VTC 8 Տեղ' : 'VTC 8 Places'}
                    </Link>
                  </div>
                )}
              </div>
          ...
          <div className="lg:hidden bg-[#1a2332] border-t border-gray-700">
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="py-1 pl-2 border-l-2 border-gray-600 space-y-1">
                ...
                <Link to={language === 'en' ? '/vtc-7-seats' : language === 'ru' ? '/vtc-7-mest' : language === 'hy' ? '/vtc-7-tegh' : '/vtc-7-places'} onClick={() => setMobileMenuOpen(false)} className="block text-white hover:text-gray-300 py-1 text-sm" data-testid="nav-vtc-7-mobile">{language === 'en' ? 'VTC 7 Seats' : language === 'ru' ? 'VTC 7 Мест' : language === 'hy' ? 'VTC 7 Տեղ' : 'VTC 7 Places'}</Link>
                <Link to={language === 'en' ? '/vtc-8-seats' : language === 'ru' ? '/vtc-8-mest' : language === 'hy' ? '/vtc-8-tegh' : '/vtc-8-places'} onClick={() => setMobileMenuOpen(false)} className="block text-white hover:text-gray-300 py-1 text-sm" data-testid="nav-vtc-8-mobile">{language === 'en' ? 'VTC 8 Seats' : language === 'ru' ? 'VTC 8 Мест' : language === 'hy' ? 'VTC 8 Տեղ' : 'VTC 8 Places'}</Link>
              </div>
              <Link
                to="/help"
                onClick={() => setMobileMenuOpen(false)}

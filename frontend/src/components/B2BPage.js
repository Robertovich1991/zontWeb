          ...
          <div className="bg-gradient-to-br from-[#151f33] to-[#1a2744] border border-gray-700/40 rounded-2xl p-8 sm:p-12">
            ...
            <form className="space-y-4 max-w-lg mx-auto" onSubmit={(e) => { e.preventDefault(); }} data-testid="b2b-contact-form">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input type="text" placeholder={c.formName || 'Your Name'} className="w-full px-4 py-3 bg-[#0c1220] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#2ecc71] transition-colors" data-testid="form-name" />
                <input type="text" placeholder={c.formCompany || 'Company'} className="w-full px-4 py-3 bg-[#0c1220] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#2ecc71] transition-colors" data-testid="form-company" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input type="email" placeholder={c.formEmail || 'Email'} className="w-full px-4 py-3 bg-[#0c1220] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#2ecc71] transition-colors" data-testid="form-email" />
                <input type="tel" placeholder={c.formPhone || 'Phone'} className="w-full px-4 py-3 bg-[#0c1220] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#2ecc71] transition-colors" data-testid="form-phone" />
              </div>
              <textarea rows="4" placeholder={c.formMessage || 'Tell us about your needs...'} className="w-full px-4 py-3 bg-[#0c1220] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#2ecc71] transition-colors resize-none" data-testid="form-message" />
              <button type="submit" className="w-full py-3.5 bg-[#2ecc71] text-white font-semibold rounded-lg hover:bg-[#27ae60] transition-all shadow-lg shadow-[#2ecc71]/20" data-testid="form-submit">
                {c.formSubmit || 'Send Your Request'}
              </button>
            </form>
